...
Before moving on, please consider giving us a GitHub star ⭐️ at [Repository](https://github.com/ultra-supara/sisakulint). Thank you!
...
```bash
$ curl -O https://github.com/ultra-supara/sisakulint/releases/download/v0.0.7/sisakulint_0.0.7_linux_amd64.tar.gz
$ tar -xzvf sisakulint_0.0.7_linux_amd64.tar.gz
$ cd < current repo for sisakulint >
